               ...
               <section className="mb-6">
                  <Link to={blocks.action_strip.downloadPath || '/catalogues'}
                    ...
                    <div className="flex flex-col text-left">
                       ...
                       <span style={{ color: blocks.action_strip.textColor || undefined }} className="text-[14px] font-black opacity-60 uppercase tracking-widest font-heading">{blocks.action_strip.subtitle || 'MASTER CATALOGUE'}</span>
                    </div>
