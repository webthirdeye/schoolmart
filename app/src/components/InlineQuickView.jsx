                ...
                <div className="space-y-3">
                    {(data.resources?.length > 0 && data.resources.some(r => r.name)) ? data.resources.filter(r => r.name).map((feat, idx) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                               <p className="text-[11px] font-bold text-gray-900 uppercase tracking-tight">{feat.name}</p>
                               {feat.size && <p className="text-[9px] text-gray-400 uppercase font-black">{feat.size}</p>}
                            </div>
                          </div>
                      ...
                      <div key={idx} className="flex items-center gap-4 p-3.5 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all group/feat">
                         ...
                         <div>
                            <p className="text-[11px] font-bold text-gray-900 uppercase tracking-tight">{feat.name}</p>
                            <p className="text-[9px] text-gray-400 uppercase font-black">{feat.size}</p>
                         </div>
                      </div>
                    ))}
                </div>
